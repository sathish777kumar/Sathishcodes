...
public class program {
	...
	public static void wet () throws Exception {
		...
		obj.get("https://www.tnstc.in/home.html");
		
		String pcode = obj.getWindowHandle();
		
		System.out.println("Parent code is:"+pcode);
		
		obj.findElement(By.xpath("//html/body/table/tbody/tr/td[2]/table/tbody/tr[4]/td[1]/table/tbody/tr[3]/td/a/img[@src='images/eTicket_button.jpg']")).click();
